...
* 紳士的距離感			(この国の排他的態度は紳士的で、公然とした罵倒や侮辱はほとんどないが、厳然と他者を拒否する。)	(排他、栄望)（実利ではない）	使節+1、統合力+5%、交易価値+5%
...
* 重商主義		(この国では貿易により通貨を蓄えることを重視しており、貿易利潤を求めている。)(資本)			政治家が交易価値+3を産む、交易価値+10%、市場手数料+5%
