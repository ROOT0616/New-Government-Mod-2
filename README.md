...
1.労働法(労働者の権利や自由を規定し、企業活動に影響を与える)
  ①企業規制	(労働者の幸福度+10%)				(労働者は国民で、国民の権利は保証されるべきだ)
  ②労働者優先	(労働者の幸福度+5%)				(労働者の過度な搾取は国家を損ねている)
  〇③一般規制							(過度な規制や緩和は社会の不安定を招く)
  ④企業優先	(労働者POPの資源産出+5%)				(労働者利益よりも企業利益こそが国家への利益へ直結する)
  ⑤規制緩和	(労働者POPの資源産出+10%、無職の召使Jobをアンロック)	(労働に値しない者は、値する者に仕えることで社会を回転させる)
...
|:------:|:------|:------|------:|------:|
| 銀河規模の拡大 | Environment and Technology | 銀河規模の拡大 | 100 | POPの成長速度+1000%、Pop製造速度+1000%。Pop消費財+50% |
...
|:------:|------:|------:|------:|
| 総督 | リーダーの獲得経験値+20% | 職からの統合力+10% | 職からの管理許容量+10% |
| 研究者 | リーダーの獲得経験値+20% | 調査速度+10% | 研究速度+5% |
| 提督 | リーダーの獲得経験値+20% | 艦隊維持費-10% | 亜空間移動速度+10% |
| 将軍 | リーダーの獲得経験値+20% | 地上軍維持費-10% | 地上軍士気+20% |

## __☆ 志向__
### __〇 社会主義__：
労働者の幸福度+5%、布告「5か年計画」を宣言可能。（企業選択不可）  狂：労働者の幸福度+10%、統治者幸福度-5%、布告「5か年計画」を宣言可能。（企業選択不可）	
...
* 農業5か年計画  ：農業生産量+20%、POPの成長速度+5%	研究力-5%
* 研究5か年計画  ：工学+10%、巨大構造物建造速度+5%	物理学-5%、社会学-5%
* 思想5か年計画  ：社会主義志向への魅力+20%、統合力+10%		安定度-5

### __〇 資本主義__：
統治者幸福度+5%、交易価値+10%	狂：統治者幸福度+10%、交易価値+10%、労働者の幸福度-10%（君主制選択不可）  

資本主義  
狂信資本  
### __〇 介入主義__：
利用可能な使節の数+1、解読力+2			狂：関係-30、利用可能な使節の数+2、解読力+5
...
* インフルエンサーJob  統治者  影響力+0.1、社会研究+5、統治志向の魅力+5%

## __☆ 国是__
### __〇 ノーマル__
* 円滑な交通			亜光移動速度+10%、交易価値+5%
* 船舶保護プロトコル 回避+20%、緊急FTL時の損傷リスク-30%、艦船連射レート-10%
* 宙間警備本部 海賊抑止力+5、交易保護値+5、交易価値+5%
* 乱脈的出生率 (ゲーム開始後の追加削除不可)POPの成長速度+10%、幸福度-5%、POPの住居使用量+5%
* 貿易国家 	交易価値+10%、市場手数料-5%、犯罪度+5
* 仮想的社会 幸福度+10%、居住性+5%、POPの成長速度-10%
* 健康的習慣 (ゲーム開始後の追加削除不可)リーダーの寿命+10年、幸福度+5%
* 文化高権 統合力+10%、リーダー取得経験値+10%

### __〇 政治制度規定__(全て相互に排他的、狂信的な浄化主義、内向きの成熟と排他的)
* 銀河連邦 		(民主制、受容主義) 派閥影響力収入+10%、リーダーの獲得経験値+20%、リーダーのスキル上限+1、政治家の一人を社会的英雄に置換え。		
* 環境民主制  (民主制、保全主義) 居住性+5%、POPの成長速度+10%、政治家の一人を大自然監督官に置換え。
* 宗教共和制 		 (民主制、精神主義) 統合力+10%、安定度+5、政治家の一人を大祭司に置換え。
* 人民民主制 			 (民主制、社会主義) Pop幸福度+5%、労働者POPの資源産出+5%、政治家の一人を書記に置換え。
...
* 共産独裁制 		 (独裁制、社会主義) 防衛軍耐久度+20%、労働者POPの資源産出+5%、政治家の一人を書記に置換え。
* 衆愚扇動制 	 		 (独裁制、実利主義) 安定度+10、政治家の一人を宣撫官に置換え。
* 騎士団 			 (君主制、軍国主義) 艦船連射レート+5%、地上軍士気+20%、政治家の一人を高級参謀に置換え。
* 名誉帝制 			 (君主制、栄望主義) 安定度+10、統合力+10%、リーダーのスキル上限+2、政治家の一人を紋章官に置換え。

書記  				安定度+5、工学+3、社会主義志向への魅力+10%
宣撫官  				労働者の幸福度+5%、労働者生産力+1%、実利主義志向への魅力+10%
紋章官  				統合力+5、惑星統合力+1%、影響力+0.01、栄望主義志向への魅力+10%
高級参謀 			防衛軍+5、宇宙軍許容量+5、安定度+5、軍国主義志向への魅力+10%
社会的英雄  			幸福度+5%、快適度+3、安定度+5
大自然監督官 	統合力+3、社会学+3、居住性+5%、保全主義志向への魅力+10%

### __〇 権威__
* 指導者原理 			(狂権威、ゲーム開始後の追加と削除不可) (カースト制、部族制、徒弟制度と相互排他)	影響力+0.5、統治志向の魅力+15%、労働者の幸福度+5%、専門家幸福度-5%、安定度-5
* 党支配				(権威、社会主義)(部族制、カースト制、徒弟制度と相互排他)統治志向の魅力+10%、布告コスト-10%、労働者生産+5%、安定度-5
* 服従の中の自由 	  	(権威、受容)	安定度+5、移民流入+10%
* カースト制度 		  	(権威、精神)(指導者原理、党支配と相互排他)	市民権がカースト制固定、統治者幸福度+10%、労働者と奴隷Popの生産量+5%、奴隷化されるPOPの割合25%、POP降格時間+300%
* 部族制 				(権威、排他)（党支配と相互排他）	POPの住居使用量-20%、統治志向への魅力+10%、統合力-5%、研究力-10%
* 宮廷政治 			(権威、栄望)	影響力+0.5、統治者幸福度+5%、統合力+10%、リーダー雇用コスト+30%、研究力-5%
* 社会ダーヴィニズム 		(狂権威)	影響力+0.5、統合力+10%、研究力+5%、POPの成長速度-10%
* 徒弟制度   			(権威、物質) (指導者原理、党支配と相互排他)	専門家POPの資源産出+5%、リーダーのスキル上限+2、リーダー選択肢-2、労働者の幸福度-5%

### __〇 平等主義__
* 直接民主制  			 						(民主制、平等主義)			影響力+0.5、布告コスト+20%
* 自由主義教育 		 						(平等主義)（実利や排他、軍国ではない）	統合力+10%、専門家生産力+5%
* デモ文化 		 				(平等)(実利、栄望ではない)		影響力+0.5、派閥満足度+5%、統治志向の魅力-5%、安定度-5
* 公開討論会  			 	(平等)(実利ではない)			統合力+10%統治志向の魅力-5%、派閥満足度+5%
* 消費社会  			 									(平等、資本主義)(狂信的社会主義ではない)			幸福度+5%、安定度+5、POP消費財維持費+10%
* 社会福祉  			 						(平等)(実利、狂信的資本主義ではない)	労働者の幸福度+5%、労働者生産力+5%、犯罪度-5%、POP消費財維持費+10%
* 宇宙規模の解放  	 						(平等、軍国)(中立ではない)		艦船連射レート+5%、造船速度+5%、宇宙軍許容量+10%
* 究極の思想的自由 	 							(狂信的平等)(ゲーム開始後の追加削除不可)				管理許容量+30%、安定度-10、統治志向の魅力-30%
* 個人武装権  		 							(平等、軍国)				地上軍ダメージ+30%、地上軍コスト-20%、犯罪発生率+10、犯罪発生率+20%

### __〇 受容主義__
* 共通価値観   					(受容)			統合力+10%、移民流入+5%
* 共に征く 	 	 		(受容)			(防衛戦争時)艦船連射レート+10%、(防衛戦争時)造船速度+5%、危機に対するダメージ+10%
* グローバル主義 					(受容、資本主義)	交易価値+10%、市場手数料-5%
* 多文化主義 						(受容、平等)		統合力+10%、POPの成長速度+5%
* 庇護主義 				(狂信的受容、介入)	属国の友好度+100、属国の受け入れ値+10、艦船連射レート+5%
* 来るものは拒まず 	 		(受容、中立)			移民流入+10%、難民政策を無制限許容で固定
* 飛び立つ民衆 			(狂信的受容)(中立、来るものは拒まずではない)		流出圧力+10%、POPの成長速度+5%

### __〇 排他主義__	
* 排他的コミュニティ  			(排他、権威)	統合力+5%、安定度+10、交易価値-5%
* 呵責なき正義 			(排他、軍国)（実利ではない）	艦隊連射レート+5%、無制限爆撃以外選択不可、犯罪度-10%、安定度-5、他国友好度-30
* 他者蔑視								(排他)（実利ではない）		影響力+0.5、防衛星系基地ダメージ力+10%、暗号力+5、交易魅力値-100
* 紳士的距離感				(排他、栄望)（実利ではない）	利用可能な使節の数+1、統合力+5%、交易価値+5%
* 痕跡の抹消												(狂排他)	統合力+10%、無制限爆撃以外選択不可、他者痕跡の抹消の開戦事由を取得（総力戦）、異種族を浄化しなくてはならない。		
* 選民思想						(排他、精神)	統合力+10%、安定度+5、精神主義志向への魅力+10%
* 異種族解剖					(排他、物質or実利)	研究力+10%、異種族は強制で奴隷化、他国友好度-100

### __〇 軍国主義__
* 帝国主義					(軍国、受容、中立ではない)	請求権作成の影響力コスト-20%、前哨地建造コスト-20%
* 大艦巨砲主義				(軍国)			船体値+10%、艦船連射レート+10%、宇宙軍許容量+30、回避-10%、亜光速* 移動速度-10%
* 軍産複合体 					(軍国、資本主義or実利)	交易保護値+5、20Popあたり兵士+1、兵士が交易価値を1生み出す。
* 戦争経済 		 					(狂信軍国)（中立ではない）		戦争疲弊-20%、戦時中の鉱物、合金、交易価値、消費財生産量+10%、造船速度+10%。非戦争時の鉱物、合金、交易価値、消費財生産量-20%、造船速度+20%
* 軍事政権									(軍国)			20popにつき兵士+1、兵士により統合力+1、安定度+5、軍国主義への魅力+10%、軍国以外の派閥満足度-5%
* 闘争のための闘争 			(狂信軍国)(ゲーム開始後の追加削除不可)		戦争疲弊-20%、戦時中の合金生産量+10%、軍艦建造コスト-5%

### __〇 平和主義__
* イージスの護り	(平和)（介入ではない）		星系基地許容量+5、星系基地ダメージ+10%、船体値+20%、暗号力+5、艦船連射レート-10%
* 繁栄主義者		(平和、実利)	労働者POPの資源産出+5%、交易価値+10%、平和の期間が1年続くごとに労働者POPの資源産出+0.2%、交易価値+0.5%（最大50年分）
* 武装平和主義		(平和、開発)	宇宙軍許容量+10、国内での連射レート+15%、船体値+10%
* 積極的平和主義者	(平和、介入)	利用可能な使節の数+1、外交発言力+10%、宇宙軍許容量+20、他国友好度-10
* 平和の使者		(狂平和)	安定度+5、亜光速移動速度+10%、危機に対する攻撃力+20%
* 誠実な交渉人		(平和、平等)	利用可能な使節の数+1、他国友好度+20

### __〇 精神主義__
* 機械信仰		(精神、開発)(ゲーム開始後の追加削除不可)	精神主義派閥がロボットに怒らなくなる。工学研究+10%、ロボット建造速度+10%、ロボット維持費+5%、ロボットを非合法化できない。ロボットの人権を市民権に固定。
* 伝道者団		(精神、介入)	利用可能な使節の数+1、隣国の精神主義志向への魅力+20%、他国友好度-50
* 信仰の擁護者		(精神、軍国)	宇宙軍許容量+20、艦船連射レート+5%、交易価値-5%、影響力+0.2、非精神主義国家友好度-30
* 亀卜（きぼく）	(狂精神)	統合力+20%、幸福度+5%、研究力-10%、精神主義志向への魅力+20%、そのほかの志向魅力-5%
* 文化の大量消費	(精神、実利)	統合力-10%、安定度+5、幸福度+5%

### __〇 物質__
* AIによる補助政治 	(物質)					統治志向の魅力+10%、幸福度+5%
...
* AI主導政治		(狂信的な物質：ゲーム開始後削除不可)	統治志向の魅力+10%、研究力+10%、安定度-10、幸福度+5%

### __〇 社会主義__
* 社会的平等		(社会、平等)	安定度+10、Pop降下時間-50%、労働者政治力+50%、市場手数料+10%
* 分配主義		(社会、精神)	労働者POPの資源産出+10%、労働者政治力+100%
* 人民軍		(社会、軍国)	防衛軍士気+20%、防衛軍ダメージ+10%、地上軍維持費-50%、地上軍編成速度+30%、攻撃軍士気-20%、攻撃軍ダメージ-10%
* 経済的原始主義	(狂社会)(ゲーム開始後の追加削除不可)	職業によるエネルギーと交易価値-20%、鉱物と農作物+20%、幸福度+20%、POP消費財維持費-50%、市場手数料+30%
* 土地の共有		(社会)		POPの住居使用量-10%、農作物と鉱物生産量+10%、居住性-5%
* 共産主義		(社会、権威)	POPの成長速度+10%、工学研究速度+5%、Pop降下速度-100%、POP消費財維持費+10%、都市区域維持コスト+20%

### __〇 資本主義__
* 開発独裁		(独裁、資本、開発)	建造速度+10%、建造コスト-10%、安定度+5、専門家幸福度-10%
* 重商主義		(資本)			政治家が交易価値+3を産む、交易価値+10%、市場手数料+5%
* 金融資本主義		(資本)			都市区域が豪商1を産む。交易価値+15%、労働者の幸福度-5%、消費財生産量-5%、合金生産量-5%
* 情報資本主義		(資本、物質)		交易価値+10%、研究力+5%、解読力+5、暗号力-5
* 農業資本主義		(資本、保全)		交易価値+10%、農作物生産+10%、居住性+5%、鉱物生産-5%
* 究極の規制緩和	(狂資本)(ゲーム開始後の追加削除不可)		専門家POPの資源産出+10%、流入圧力+10%、犯罪度+20、犯罪度+15%、労働者の幸福度-10%、安定度+10
...
* 笑顔の仲介者		(介入、平和)	利用可能な使節の数+1、取引受諾値+50、交易価値+5%、友好度+20、統治志向の魅力-10%
* 国際的黒幕		(狂介入)(ゲーム開始後の追加削除不可)	利用可能な使節の数+1、暗号力+5、解読力+5、外交発言力+10%、友好度-30
...
* 武装中立		(中立、軍国)	星系基地許容量+3、星系基地船体値+10%、ステーション連射レート+10%、
* 利益代表国		(中立、平和)	利用可能な使節の数+1、交易価値+10%、市場手数料-5%
...
* 絶滅防止法		(狂保全)(ゲーム開始後の追加削除不可)	社会学研究+20%、統合力+10%、POP消費財維持費+10%、
...
### __〇 栄望主義__
* 高度な栄典制度	(栄望)		以下略
* 複雑な外交儀礼	(栄望、削除不可)利用可能な使節の数+1、影響力+1、消費材消費量+5%、友好度-10
* 栄典交換		(栄望、受容)	統合力+10%、友好度+20、志向転向度+5%
* 英雄志願部隊		(栄望、軍国)	攻撃軍士気+20%、攻撃軍ダメージ+10%、攻撃軍製造コスト+20%
* 独善的な英雄		(栄望、排他)	統合力+20%、艦船連射レート+5%、使節-1
* 称号と敬称の尊重法	(狂栄望)	25Popあたり1の貴族、影響力+1、栄望主義志向への魅力+10%、移民流入-10%、幸福度-5%

### __〇 実利主義__
* 個人利益至上法	(実利、資本)	エネルギー生産+10%、交易価値+10%、犯罪度+10、犯罪度+10%
* 人権への抵当権	(実利、権威)	安定度+10、奴隷生産量+5%、奴隷購入コスト-10%、幸福度-10%
* 刑罰の金銭代替	(狂実利)	惑星の犯罪*1の交易価値を惑星に付与、交易価値+10%、犯罪度+10、犯罪度+10%
* 適切な利益誘導	(実利)		安定度+5、エネルギー生産+10%、交易価値+20%、市場手数料-5%、労働者の幸福度-5%
* 実益の確保		(実利)		外交発言力+10%、艦船連射レート+5%、請求権作成の影響力コスト-10%、友好度-10
* 高度生産消費社会	(実利、資本)	労働者POPの資源産出+10%、専門家生産量+5%、POP消費財維持費+20%
...
* 治癒遺伝子	：2p	POPの成長速度+5%、リーダーの寿命+10年、地上軍耐久度+30%	
* 修復不能  	：-2p	POPの成長速度-5%、リーダーの寿命-10年、地上軍耐久度-30%	

* 身体的同化	：1p	居住性+10%、Popの移住-10%	
* 適応不足  	：2p	居住性-10%、Popの移住+10%	

* 生体分裂  	：2p	POPの成長速度+10%				
* 多産多死  	：0p	POPの成長速度+5%、リーダーの寿命-30年	
* 少子長命  	：0p	POPの成長速度-5%、リーダーの寿命+30年	

* 異常発達  	：1p	POPの成長速度+20%、防衛軍強度+20%、統合力-20%、研究力-10%	
* 失われし種	：1p 	POPの成長速度-50%、統合力+20%、研究力+20%			

* 縄張り意識	：-2p	強制移住コスト+25%、Popの流入-10%、防衛軍士気+10%、POPの住居使用量+5%	
* 移動性社会	：2p	強制移住コスト-25%、Popの流入+10%、POPの住居使用量-5%、侵攻軍士気+10%	
...
* 光学適応  	：2p	地上軍耐久度+30%、POPの住居使用量-5%、快適度消費-5%、犯罪発生+5%	(この種族は光学的に周囲へ溶け込むことで隠れることができる。)
* 硬質器官  	：2p	地上軍ダメージ+20%、地上軍耐久度+20%、鉱物生産+5%		(この種族は体の一部を硬化させることができる。)
* 神経遮断  	：2p	地上軍士気+40%、リーダーの寿命+5年				(この種族は痛覚神経を一時的に遮断させ、痛みを避けることができる。)
...
* 巨大      	：3p	Popの食料消費量+10%、POPの住居使用量+15%、地上軍ダメージ+20%、地上軍耐久度+20%、家畜からの食料+3、Popの鉱物・エネルギー・食料生産+10%	(この種族の身体は銀河基準からしても巨大である。)
* 大型      	：2p	Popの食料消費量+5%、POPの住居使用量+10%、地上軍ダメージ+10%、地上軍耐久度+10%、家畜からの食料+1、Popの鉱物・エネルギー・食料生産+5%		(この種族の身体は銀河基準からしても大柄である。)
* 小型      	：-2p	Popの食料消費量-5%、POPの住居使用量-10%、地上軍ダメージ-10%、地上軍耐久度-10%、家畜からの食料-1、Popの鉱物・エネルギー・食料生産-5%		(この種族の身体は銀河基準からしても小型である。)
* 極小      	：-3p	Popの食料消費量-10%、POPの住居使用量-15%、地上軍ダメージ-20%、地上軍耐久度-20%、家畜からの食料-3、Popの鉱物・エネルギー・食料生産-10%	(この種族の身体は銀河基準からしても極小である。)
...
* 非言語社会      ：-2p	研究力-10%、統合力-5%、POPの成長速度+3%	(この種族には言語という概念が存在しない。)
* 無文字社会      ：-2p	研究力-10%				(この種族には文字という概念が存在しない。)

* 美味な肉体      ：0p	家畜からの食料+2					(この種族は美味しい！)
* 不味い肉体      ：+1p	家畜からの食料-2、Popの食料消費量-10%			(この種族は不味い！)
* 霜降り          ：-1p	家畜からの食料+1、Popの食料消費量+10%、リーダーの寿命-5年	(この種族は全身が霜降りである。)
...
* 感光性          ：-1p	POPの快適度使用量+10%	(この種族は極めて光に弱く、光を避ける傾向にある。)
* 好光性          ：-1p	POPの住居使用量+5%		(この種族は光を好み、日光を浴びることを好む。)

* インドア派      ：-1p	POPの住居使用量+10%	(この種族は屋内での活動を好む。)
* アウトドア派    ：+1p	POPの住居使用量-10%	(この種族は屋外での活動を好む。)
...
* 優秀な個性      ：3p	リーダー取得経験値+10%、リーダーのスキル上限+2	(この種族は個々の個性を伸ばすことを重要視している。)
* 無個性          ：-3p	リーダー取得経験値-10%、リーダーのスキル上限-2	(この種族は個々の個性を均一化することを重要視している。)

* 社交性          ：2p	職業による快適度+10%、職業による統合力+5%	(この種族は社交的だ。)
* 内向性          ：-2p	職業による快適度-10%、職業による統合力-5%	(この種族は内向的だ。)

* 精神的開放  	：-4p	統治志向の魅力-30%	(この種族は精神的な束縛を嫌う。)
* 精神的自由  	：-2p	統治志向の魅力-15%	(この種族は精神的な自由を重視している。)
* 精神的権威  	：2p	統治志向の魅力+15%	(この種族は精神的に誰かに従うことに慣れている。)
* 精神的従属	：4p	統治志向の魅力+30%	(この種族は精神的に誰かの管理下に置かれることを好んでいる。)
...
* 同族殺し（ヒューマノイド）  ：-2p	統合力-10%、安定度-5%、軍国主義志向への魅力+10%、平和主義志向への魅力-10%	(この種族は互いに殺し合いを行う悪習がある。)
* 美しい毛並み（哺乳類）      ：2p	職業による快適度+10%、居住性+5%					(この種族の毛並みは長く、美しい。)
* 暴力的本能（哺乳類）        ：-2p	地上軍士気-10%、統合力-5%、地上軍士気+5%			(この種族は本能的に粗暴である。)
* 身軽な身体（鳥）            ：2p	回避+5%、POPの住居使用量-10%						(この種族は体重が少ない割に筋肉量が多く、身軽に動くことができる。)
* 鳥頭（鳥）                  ：-2p	研究力-10%、統合力-5%、幸福度+5%、統治志向の魅力+10%		(この種族の脳は小さく、すぐ忘れてしまう。)
...
* 変態（虫）                  ：-2p	POPの成長速度-10%、POPの住居使用量-5%					(この種族は幼体から成体になる間に大きな形態変化を必要とするほか、変態時に突然死することも多い。)
* 柔軟な筋肉（軟体人）        ：2p	鉱物生産量+5%、地上軍ダメージ+10%				(この種族の筋肉は柔軟で、強度も高い。)
* 腐食性粘液（軟体人）        ：-2p	POP消費財維持費+10%、地上軍攻撃力+5%				(この種族が分泌する粘液は腐食性で、様々なものを壊すことが多い。)
* 高分子分解（菌類）          ：2p	POPの成長速度+10%							(この種族は様々なものを分解し、栄養とすることができる。)
* 変性胞子（菌類）            ：-2p	職業による快適度-10%、居住性-5%、統合力+5%			(この種族の胞子は周囲に予測可能性の低い影響を与える。)
* 光合成（植物）              ：2p	食料消費量-20%、居住性+5%					(この種族は光合成により栄養を手に入れることができる。)
* 遅速性（植物）              ：-2p	地上軍耐久度-30%、POPの住居使用量+10%、リーダーの寿命+15年		(この種族の足は遅く、動作が緩慢である。)
...
* 高度防衛計画						(星系基地許容量+10、防衛プラットフォームの上限+150、星系基地船体値+50%)
...
* ハニカムハウス			(コロニー船建造コスト-50%、区域建造コスト-20%、POPの住居使用量-30%)
...
開催地決定
  ...
  (当該惑星5年間統合力+20%、交易価値+20%、幸福度+5%、POPの成長速度+10%、Pop製造速度+10%、流入魅力+30%。犯罪度+20%)
...
別枠
1.観艦式(栄望もしくは軍国のみ主催可能。エネルギー1000、影響50を消費。銀河コミュニティ加盟国に呼びかけ、3ヵ国以上の参加で開催。消費後に1年以内に首都惑星で軍艦1隻以上を当てるプロジェクトを遂行すれば達成。主催国は影響力200と5年間軍国主義、栄望主義志向への魅力+20%、5年間外交発言力+20%)参加国は影響100と2年間外交発言力+10%を獲得。
...
決議「観艦式の実施」
観艦式（主催国は影響力200と5年間軍国主義、栄望主義志向への魅力+20%、5年間外交発言力+20%)
